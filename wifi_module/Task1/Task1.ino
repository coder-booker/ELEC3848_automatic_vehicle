...
void setup() {
    ...
    // esp8266_server.on("/message", HTTP_POST, []() { // Handle HTTP GET request at /message
    ...
    webPage += "<div id=\"img_stream\" width=\"640px\" height=\"640px\"></div>";
    ...
    //       // 将图片元素添加到HTML文档中
    //       const imageContainer = document.getElementById(\"img_stream\");
...
void handleWifiClient() {
  if (!client.connected()) {
    client = wifi_server.available();  // Listen for incoming clients
